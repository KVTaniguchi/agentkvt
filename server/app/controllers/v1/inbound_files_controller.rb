...
module V1
  class InboundFilesController < BaseController
    ...
    def create
      ...
      file_data = decode_file_data!(attrs.delete("file_base64"))
    ...
    def inbound_file_params
      params.require(:inbound_file).permit(:id, :file_name, :content_type, :uploaded_by_profile_id, :file_base64)
    end

    def decode_file_data!(file_base64)
      raise ArgumentError, "inbound_file[file_base64] is required" if file_base64.blank?
