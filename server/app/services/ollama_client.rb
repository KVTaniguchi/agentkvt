...
class OllamaClient
  ...
  def chat(messages:, model: DEFAULT_MODEL, format: nil, task: nil, options: {}, open_timeout: 10, read_timeout: 300)
    ...
    response = Net::HTTP.start(uri.host, uri.port, read_timeout: read_timeout, open_timeout: open_timeout) do |http|
