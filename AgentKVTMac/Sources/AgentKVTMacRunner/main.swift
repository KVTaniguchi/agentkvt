...
struct Main {
    static func main() async {
        ...
        let client = OllamaClient(baseURL: URL(string: ProcessInfo.processInfo.environment["OLLAMA_BASE_URL"] ?? "http://localhost:11434")!, model: ProcessInfo.processInfo.environment["OLLAMA_MODEL"] ?? "llama3.2")
    ...
    static func runSingleTest(registry: ToolRegistry, client: OllamaClient) async {
    ...
    static func runScheduler(context: ModelContext, client: OllamaClient, registry: ToolRegistry, emailIngestor: EmailIngestor) async {
